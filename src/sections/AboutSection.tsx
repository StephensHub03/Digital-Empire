...
const ABOUT_TEXT =
  "I'm a MERN stack developer building AI-powered web applications and intelligent automation projects that are fast, scalable, and user-focused. I specialize in React, Node.js, Express, MongoDB, and Firebase — creating clean, responsive interfaces and robust backend systems built for real-world performance.!"
